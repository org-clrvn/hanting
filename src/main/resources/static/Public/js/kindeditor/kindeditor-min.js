...
(function(w, i) {
    ...
    function Ma(a) {
        var b = "<video class='embed' id='player' name='player' allowscriptaccess='always' allowfullscreen='true' ";
        m(a,
        function(a, d) {
            b += a + '="' + d + '" '
        });
        b += " controls  preload='auto'></video>";
        return b
    }
    function qb(a, b) {
        var c = b.width,
    ...
    if (!w.KindEditor) {
        ...
        f.options = {
            ...
            htmlTags: {
                ...
                embed: ["id", "class", "src", "width", "height", "type", "loop", "autostart", "quality", ".width", ".height", "align", "allowscriptaccess", "flashvars", "controls", "preload"],
                video: ["id", "class", "src", "width", "height", "type", "loop", "autostart", "quality", ".width", ".height", "align", "allowscriptaccess", "flashvars", "controls", "preload"],
        ...
        ua.prototype = {
            ...
            text: function(a) {
                return a === i ? B(this.html().replace(/<(?!img|video).*?>/ig, "").replace(/&nbsp;/ig, " ")) : this.html(C(a))
            },
            isEmpty: function() {
            ...
            count: function(a) {
                ...
                if (a === "text") return this.text().replace(/<(?:img|video).*?>/ig, "K").replace(/\r\n|\n|\r/g, "").length;
                return 0
            },
            exec: function(a) {
                var a = a.toLowerCase(),
        ...
        function(a) {
            ...
            b.beforeSetHtml(function(a) {
                ...
                return a.replace(/<video[^>]*type="([^"]+)"[^>]*>(?:<\/video>)?/ig,
                function(a) {
                    a = I(a);
                    a.src = l(a.src, "");
                    a.width = l(a.width, 0);
